...
const Navbar = () => {
  ...
  const link = (
    <>
      ...
      <li className="font-semibold text-lg dark:text-white">
        <NavLink to="/pendingRequest">pending requests</NavLink>
      </li>
      <li className="font-semibold text-lg dark:text-white">
      ...
      <div className="navbar z-50 bg-base-100 dark:bg-slate-800">
        <div className="navbar-start">
          ...
          <div className="flex items-center gap-2">
            <img
              className="w-10 h-10 md:w-20 md:h-20 rounded-full bg-cover"
            ...
            <>
              <details className="dropdown dropdown-bottom dropdown-end">
                <summary className="flex ">
                  <img
                    className="w-10 h-10 md:w-14 md:h-14 mx-1 rounded-full object-cover object-center"
                    src={user?.photoURL}
                    alt=""
                  />
                </summary>
                <ul className="p-2 shadow menu dropdown-content z-[1] bg-base-100 rounded-box w-52">
                  <Link
                    ...
                    className="flex justify-center items-center text-xl mt-3 btn"
                  >
                  ...
                  <button
                    ...
                    className="btn mt-8 bg-red-600 text-white"
                  >
