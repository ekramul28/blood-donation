...
const DonationRequest = () => {
    ...
    return (
        <div>
            {
                (user?.Status === 'block') ? <div className="flex justify-center items-center"><h1 className="text-red-500 text-xl font-bold">You are a Block user You can not Request </h1></div>
