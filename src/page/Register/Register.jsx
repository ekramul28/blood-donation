...
const Register = () => {
  ...
  const demoAdmin = () => {
    login("mdekramulhassan1@gmail.com", "Ekramul28@");
  ...
  return (
    <div className="hero min-h-screen bg-base-100 ">
      <div className="hero-content flex-col w-80 md:w-[400px]  lg:w-[900px]">
        ...
        <div className="card flex-shrink-0 w-full   shadow-2xl bg-base-100">
          <form onSubmit={handelForm} className="card-body ">
            ...
            <div className="form-control mt-6">
              <button className="btn bg-red-600 border-none text-white">
                Register
              </button>
              <div className="mt-3">
                <p className="text-xl">
                  you have Account please
                  <Link to="/login" className="text-red-600 text-2xl ml-3">
                    login
                  </Link>
                </p>
              </div>
        ...
        <div
          onClick={demoAdmin}
          className=" border-2 border-white rounded-xl mt-5 bg-red-600"
        >
          <p className="flex justify-center items-center gap-3 text-xl font-semibold text-white px-6 py-4">
            {" "}
            Demo Admin
          </p>
        </div>
