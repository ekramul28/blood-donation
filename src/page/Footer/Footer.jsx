        ...
        <div >
            <footer className="footer footer-center p-10 bg-base-200 text-base-content dark:bg-slate-800 rounded">
                <div className="flex items-center gap-2">
                    <img className="w-20 h-20 rounded-full bg-cover" src="https://i.ibb.co/7nHmfGY/vecteezy-hand-holding-a-drop-of-blood-world-blood-donor-day-blood-19152949-removebg-preview-1.png" alt="" />
                    <h1 className="text-2xl font-semibold text-red-600">Grant</h1>
